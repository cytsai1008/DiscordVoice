...
async def gpt_process(lang: str, content: str) -> str:
    ...
    model = google.generativeai.GenerativeModel(
        ...
        system_instruction=f"If no specific language is requested, use {lang} as a friendly human to respond. "
        f"Otherwise, reply in the language requested by the user. Reduce using emojis.",
    )
